...
module.exports = {
    ...
    async handleConfigCommand(subsystem_command, subsystem_option) {
        ...
        if (subsystem_command === 'chain_id') {
            this.setchainId(subsystem_option);
            await this.saveVaultData();
    ...
    setchainId(chainId) {
        vaultData.chainId = chainId;
        miningLogger.print('Selected chain id:', chainId)
    },
    getChainId() {
        return vaultData.chainId;
    },
    getMiningPool() {
