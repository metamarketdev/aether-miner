...
function init() {
    ...
    if(process.argv.length > 2) {
        ...
        drawLayout();
        console.log('Welcome to Aether: Community Miner including CUDA')
        console.log('HashBurner build by Snappy [V3.4t] - "Cookin your Hashbrowns" ')
        console.log('based on v2.10.0pre5+ by Snappy & the 0xBitcoin Discord Crew')
        console.log('')
...
function printHelp() {
    ...
    console.log('"config chain_id #"      - Set the chainid for different networks')
    ...
    console.log('"mine"                   - Begin solo mining using CPU')
